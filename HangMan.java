...
public class HangMan extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Line base = new Line(pole.getEndX(), pole.getEndY(), pane.getWidth() / 1.5, pole.getEndY());
        list.add(base);
        Line hang = new Line(base.getEndX(), base.getEndY(), base.getEndX(), pane.getHeight() / 6);
        list.add(hang);

        double radius = WIDTH / 10;
        Circle c = new Circle(base.getEndX(), pane.getHeight()/ 6 + radius, radius);
